...
@WebServlet("/PetPlanet/writeFAQ02")
public class WriteController extends HttpServlet {
	
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.getRequestDispatcher("/PetPlanet/writeFaq02.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (mr == null) {
			...
			JSFunction.alertLocation(resp, "제한 용량 초과! or 디렉토리 경로 확인!", "../PetPlanet/writeFAQ02");
		...
		if (result == 1) {
			System.out.println("FAQ02게시판 입력 성공");
			resp.sendRedirect("../PetPlanet/board");
		} else {
			System.out.println("FAQ02게시판 입력 실패");
			resp.sendRedirect("../PetPlanet/writeFAQ02");
		}
	}
}
