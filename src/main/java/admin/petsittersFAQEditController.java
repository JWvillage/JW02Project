...
@WebServlet("/admin/editPetSittersFAQ")
public class petsittersFAQEditController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("./editPetSitters_FAQ.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (mr == null) {
			...
			JSFunction.alertLocation(resp, "제한 용량 초과! or 디렉토리 경로 확인!", "../admin/editPetSittersFAQ");
...
//		}
		...
		if (result == 1) {
			...
			resp.sendRedirect("./editPetSittersFAQ");
		}
	}
}
