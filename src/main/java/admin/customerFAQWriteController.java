...
@WebServlet("/admin/writeCustomerFAQ")
public class customerFAQWriteController extends HttpServlet {
	
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.getRequestDispatcher("./writeCustomer_FAQ.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (mr == null) {
			...
			JSFunction.alertLocation(resp, "제한 용량 초과! or 디렉토리 경로 확인!", "./writeCustomerFAQ");
		...
		if (result == 1) {
			...
			resp.sendRedirect("../admin/customerFAQ");
		} else {
			System.out.println("FAQ01게시판 입력 실패");
			resp.sendRedirect("../admin/writeCustomerFAQ");
		}
	}
}
