...
@WebServlet("/admin/editCustomerFAQ")
public class customerFAQEditController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("./editCustomer_FAQ.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (mr == null) {
			...
			JSFunction.alertLocation(resp, "제한 용량 초과! or 디렉토리 경로 확인!", "../admin/editCustomerFAQ");
...
//		}
		...
		if (result == 1) {
			...
			resp.sendRedirect("./customerFAQ");
		} else {
			System.out.println("FAQ게시판 수정 실패");
			resp.sendRedirect("../admin/editCustomerFAQ");
		}
	}
}
