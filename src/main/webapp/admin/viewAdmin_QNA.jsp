    ...
    $("#delete").click(function () {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                location.href='./deleteAdminQNA?num=${ qto.num }'
            }
        })
    });
});
				...
				<div style="margin-top: 200px; border-top: 1px solid #cccccc; width: 1024px;">
					...
					<div style="border-bottom: 1px solid #cccccc; padding-bottom: 20px; background-color: #fcfcfc;">
						...
						<div style="margin-top: 150px;">
							<input type="button" onclick="location.href='./editAdminQNA?num=${ qto.num }'" value="수정하기" style="border: 0; background: none; color: black; padding-right: 20px; width: 60px;" />
