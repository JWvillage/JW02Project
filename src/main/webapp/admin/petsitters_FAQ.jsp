                        ...
                        <div class="card mb-4" style="margin-top: 100px">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <c:forEach items="${ FAQboard }" var="FAQ" varStatus="loop">
                                        <tr>
                                            <td>
                                            ...
                                            <td>${ FAQ.id }</td>
                                            <td>
                                            	<a href="./viewPetSittersFAQ?num=${ FAQ.num }">
	                                            	${ FAQ.title }
                                            	</a>
                                            </td>
                                            <td>${ FAQ.content }</td>
                                            ...
                                            <td>${ FAQ.ofile }</td>
                                            <td>
                                            <c:if test="${ not empty FAQ.ofile }">
												<a href="../PetPlanet/download?ofile=${ FAQ.ofile }&sfile=${ FAQ.sfile }&num=${ FAQ.num }" style="padding-top: 150px">
							    ...
							    <div style="display: flex; justify-content: center; width: 1000px; margin-top: 50px">
							        <a href="./writePetSittersFAQ" style="text-align:center;padding-top:10px; color: #81A3F0; font-weight: bold; width: 120px; height:45px; border: 1px solid #81A3F0; border-radius: 20px">작성하기</a>
						        </div>
                            </div>
                        </div>
                    </div>
