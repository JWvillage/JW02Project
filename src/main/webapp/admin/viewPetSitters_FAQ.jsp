    ...
    $("#delete").click(function () {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                location.href='./deletePetSittersFAQ?num=${ qto.num }'
            }
        })
    });
});
					...
					<div style="border-bottom: 1px solid #cccccc; padding-bottom: 20px; background-color: #fcfcfc;">
						...
						<c:if test="${ sessionScope.u_id eq qto.id }" var="result">
							...
							<div style="margin-top: 150px;">
								<input type="button" onclick="location.href='./editPetSittersFAQ?num=${ qto.num }'" value="수정하기" style="border: 0; background: none; color: black; padding-right: 20px; width: 60px;" />
