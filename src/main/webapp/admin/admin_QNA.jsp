                        ...
                        <div class="card mb-4" style="margin-top: 100px">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <c:forEach items="${ QNAboard }" var="QNA" varStatus="loop">
                                        <tr>
                                            <td>
                                            ...
                                            <td>${ QNA.id }</td>
                                            <td>
                                            	<a href="./viewAdminQNA?num=${ QNA.num }">
	                                            	${ QNA.title }
                                            	</a>
                                            </td>
                                            <td>${ QNA.content }</td>
                                            ...
                                            <td>${ QNA.ofile }</td>
                                            <td>${ QNA.likecount }</td>
                                            <td>${ QNA.visitcount }</td>
                                            <td>
                                            <c:if test="${ not empty QNA.ofile }">
												<a href="../PetPlanet/download?ofile=${ QNA.ofile }&sfile=${ QNA.sfile }&num=${ QNA.num }" style="padding-top: 150px">
