                        ...
                        <div class="card mb-4" style="margin-top: 100px">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <c:forEach items="${ FAQboard }" var="FAQ" varStatus="loop">
                                        <tr>
                                            ...
                                            <td>${ FAQ.id }</td>
                                            <td>
                                            	<a href="./viewCustomerFAQ?num=${ FAQ.num }">
	                                            	${ FAQ.title }
                                            	</a>
                                            </td>
                                            <td>${ FAQ.content }</td>
							    ...
							    <div style="display: flex; justify-content: center; width: 1000px; margin-top: 50px">
							        <a href="./writeCustomerFAQ" style="text-align:center;padding-top:10px; color: #81A3F0; font-weight: bold; width: 120px; height:45px; border: 1px solid #81A3F0; border-radius: 20px">작성하기</a>
						        </div>
                            </div>
                        </div>
                    </div>
