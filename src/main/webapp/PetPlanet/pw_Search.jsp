...
<script>
  function checkSearchForm(fm) {
    var id_ch = document.getElementById('id_ch');
    var name_ch = document.getElementById('name_ch');
    if(!fm.search_id.value) {
      id_ch.style.color = 'red'
      id_ch.innerHTML = "아이디를 입력하세요!"
      fm.search_id.focus();
      return false;
    } 
...
<!-- pw_Search Form -->
<form action="/J03Project/PetPlanet/PwSearch" method="post" onsubmit="return checkSearchForm(this);">
            ...
            <div style="width: 475px; height: 59px; display: flex; align-items: center; border: 1px solid #cccccc; margin-top: 10px; padding: 0 0 0 17px">
              ...
              <div>
                <input
                  ...
                  onblur="id_SearchMessage(this.form);"
                />
              </div>
            </div>
            <div style="margin-top: 5px;">
              <p><span id="id_ch" style="color: skyblue"></span></p>
            </div>
          </div>
          <!-- Name -->
